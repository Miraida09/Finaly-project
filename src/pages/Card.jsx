      ...
      <div className="cart-page__content">
              ...
              <div key={item.id} className="cart-page__item">
                ...
                <div className="cart-page__item-info">
                  ...
                  <div className="cart-page__item-price-wrapper">
                    {hasDiscount && (
                      <span className="cart-page__item-old-price">${oldPrice.toFixed(2)}</span>
                    )}
                    <span className="cart-page__item-price">${finalPrice.toFixed(2)}</span>
                  </div>
                </div>
        ...
        <div className="cart-page__totals">
          ...
          <div className="cart-page__totals-row">
            ...
            <span className="cart-page__totals-value">${subtotal.toFixed(2)} AUD</span>
          </div>
          <div className="cart-page__totals-row cart-page__totals-row--total">
            <span className="cart-page__totals-label">TOTAL</span>
            <span className="cart-page__totals-value">${total.toFixed(2)} AUD</span>
          </div>
